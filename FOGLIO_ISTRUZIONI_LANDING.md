...
1. **`registrati.html`** — la landing con il form per l'email. Mostra le due ricompense
...
- Il form (in `registrati.html`) invia l'email digitata a `/api/register`.
...
```
registrati.html      (NUOVO)  landing + form email
